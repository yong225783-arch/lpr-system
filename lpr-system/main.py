...
def ocr_with_ocr_best(crop_img):
    ...
    try:
        ...
        PLATE_PATTERNS = [
            ...
            r'^[0-9]{4}-[A-Z]{2,3}$',       # 0000-XXX（機車，4位數）
            r'^[0-9]{1,4}-[A-Z]{2,3}$',     # X-XXX ~ 0000-XXX（數字-字母混合）
...
def filter_plate_text(ocr_texts):
    ...
    plate_patterns = [
        ...
        r'[0-9]{3}-[A-Z]{2,3}',       # 220-GJW, 123-ABC (3位數-2/3字母)
        r'[0-9]{2}-[A-Z]{2,3}$',     # 12-ABC, 12-AB (2位數-2/3字母，嚴格匹配結尾)
